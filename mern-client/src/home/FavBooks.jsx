...
const FavBooks = () => {
  return (
    <div className='px-4 lg:px-24 my-28 flex flex-col md:flex-row justify-between items-center gap-12'>
      ...
      <p className='mb-10 text-lg md:w-5/6'>Lorem Ipsum consists of a single, 60,000-word sentence. 
      ...
      prose genre of the zui&hi&tsu, an unfolding sentence in which resolution and closure are endlessly 
       ...
       <div className='flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14'>
        ...
        <div>
          ...
          <Link to="/shop" className='-ml-77 mt-5 block'><button className='bg-blue-700 text-white font-semibold px-5 py-2 rounded
